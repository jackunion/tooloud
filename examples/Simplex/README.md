...
```javascript
const n = tooloud.Simplex.noise(x, y, z);
...
```javascript
const n = (1 + tooloud.Simplex.noise(x, y, z)) / 2;
data[index + 0] = Math.floor(255 * n);
data[index + 1] = Math.floor(255 * n);
data[index + 2] = Math.floor(255 * n);
data[index + 3] = 255;
...
```javascript
const n = Math.cos(tooloud.Simplex.noise(i/45, j/120, z) * 50);
data[index + 0] = Math.floor(255 * n);
data[index + 1] = Math.floor(255 * n);
data[index + 2] = Math.floor(255 * n);
data[index + 3] = 255;
...
const n = (1 + tooloud.Simplex.noise(i/5, j/5, 0.8)) / 2;
